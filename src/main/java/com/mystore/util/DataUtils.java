...
public class DataUtils {
    ...
    private static final Logger logger = (Logger) LogManager.getLogger(DataUtils.class);
    ...
    public static void readTestDataFromExcelSheet(String testCaseId, String sheetName) {
        try (InputStream inputStream = ResourceLoader.getResourceAsStream(EXCEL_FILE_PATH)) {
            ...
            logger.info("Reading data from sheet {} for testcase {}", sheetName, testCaseId);
            ...
            logger.error("Failed in readTestDataFromExcelSheet() : ", e);
